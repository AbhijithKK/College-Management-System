...
import {
  FacultyLeaveActionApi,
  FacultyLeaveLettersApi,
} from "../../../api/FacultyApi";
...
export default function CheckLeaveLetter() {
  ...
  return (
    <>
      ...
      >
        <Container>
          <h1 className="clubReqTitle" style={{ paddingTop: "10px" }}>
            Leave Requests
          </h1>
                      ...
                      <TableCell style={{ width: 160 }}>
                        {row.status === Accept ? (
                          <Tooltip
                            ...
                            type="button"
                            onClick={() =>
                              Action(row._id, Reject, row.adminName)
                            }
                          >
                            <Button>
                              <Close  style={{color:"rgba(60, 34, 34, 0.96)" }} />
                            </Button>
                          </Tooltip>
                        ) : row.status === Reject ? (
                          <Tooltip title="Approve">
                            <Button
                              type="button"
                              onClick={() =>
                                Action(row._id, Accept, row.adminName)
                              }
                            >
                              <Done  style={{color:"rgba(60, 34, 34, 0.96)" }} />
                            </Button>
                          </Tooltip>
                        ) : (
                          <>
