...
import PaymentHistory from "../../CommonPages/PaymentHistory/PaymentHistory";
...
function CreatePayment() {
  ...
  return (
    <>
      <div
        style={{ backgroundColor: "gray", marginTop: "0px", height: "100vh" }}
      >
        <SideBarStudent />
        <MDBContainer
          fluid
          ...
          <MDBCard className="m-5" style={{ maxWidth: "600px" }}>
            <MDBCardBody className="px-5">
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <Button onClick={handleClickOpen}>view Payments</Button>
                <br />
        ...
        <div className="PayHistoryAdmin">
          <Container>{hSeter && <PaymentHistory />}</Container>
        </div>
      </div>
    </>
  );
