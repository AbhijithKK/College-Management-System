    ...
    <>
      ...
      >
        <Container>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  ...
                  {moreInfo.who}
                  <br />
                  {moreInfo.department} Department
                  <br />
                  {moreInfo.className ? `${moreInfo.className} Class` : ""}
                  <br />
                  {moreInfo.date}
                  <br />
                  {moreInfo.teachingArea}
                  <br />
                </DialogContentText>
              </DialogContent>
              <DialogActions>
          ...
          {allCompliant.length > 0 ? (
            allCompliant.map((data, index) => (
              <Row key={index} style={{ marginLeft: "72px", marginTop: "5px" }}>
                <Col xs={12} md={12} lg={12}>
                  <Box className="customViewComplaint-Clubcard">
                    {" "}
                    {/* Add custom CSS class */}
                    <Card
                      variant="outlined"
                      className="customViewComplaint-clubcard"
                    >
                      {" "}
                      {/* Add custom CSS class */}
                      <CardContent>
                        ...
                        <Typography
                          sx={{ mb: 1.8 }}
                          color="text.secondarmoreInfo.classNamey"
                        >
                          Name: {data.name}
                        </Typography>
                        <Typography
