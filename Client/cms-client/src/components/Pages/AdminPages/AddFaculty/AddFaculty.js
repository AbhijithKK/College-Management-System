...
function Addfaculty() {
  ...
  const SendData = () => {
    if (
      value.names.trim() &&
      value.email.trim() &&
      value.mobNumber.trim() &&
      value.dob.trim() &&
      value.admYear.trim() &&
      value.qualification.trim() &&
      value.teachingArea !== "sub" &&
      value.address.trim() &&
                    ...
                    <Row>
                      <Col sm={12} md={6}>
                        ...
                        <Form.Select
                          ...
                          onChange={Handlevalue}
                        >
                          <option hidden value={value.department}>
                            Select Department
                          </option>
                          {dept.map((data, index) => (
                      ...
                      <Col sm={12} md={6}>
                        ...
                        <Form.Select
                          id="disabledSelect"
                          value={value.teachingArea}
                          name="teachingArea"
                          onChange={Handlevalue}
                        >
                          <option hidden value="sub">
                            Select subject
                          </option>
                  ...
                  <Form.Group>
                    <Row>
                      ...
                      <Col sm={12} md={6}>
                        ...
                        <Form.Select
                          id="disabledSelect"
                          value={value.adminOfClass}
                          name="adminOfClass"
                          onChange={Handlevalue}
                        >
                          <option hidden value="noAdmin">
                            Select class
                          </option>
