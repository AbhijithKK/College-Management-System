...
import { ApiGetpaymentHistory } from '../api/AdminApi';
...
export default function PaymentHistory() {
  ...
  const GetApi=async()=>{
    let data=await ApiGetpaymentHistory()
    setResult(data)
  }                     
  React.useEffect(()=>{
    GetApi()
  ...
  return (
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 300 }} aria-label="custom pagination table">
        <TableBody>
          <TableRow>
            <TableCell style={{ fontWeight: "bold" }} align="center">Student Name</TableCell>
            <TableCell style={{ fontWeight: "bold" }} align="center">Department</TableCell>
            <TableCell style={{ fontWeight: "bold" }} align="center">Payment Title</TableCell>
            <TableCell style={{ fontWeight: "bold" }} align="center">Amount</TableCell>
            <TableCell style={{ fontWeight: "bold" }} align="center">Pay Date</TableCell>
          ...
          {result.length > 0 ? (rowsPerPage > 0
            ...
            <TableRow key={i}>
              ...
              <TableCell align="center" style={{backgroundColor:row.status==='true'?'green':'red'}}>
