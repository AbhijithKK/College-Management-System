...
const view = [
    { text: 'Leave Status', link: '/student/leaveStatus', icon: <PendingActionsSharp /> },
    { text: 'Apply Leave', link: '/student/applyleave', icon: <PendingActionsSharp /> },
    { text: 'Notification Calender', link: '/student/notificationCalander', icon: <CalendarMonthSharp /> },
