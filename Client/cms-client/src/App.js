...
function App() {
  ...
  const { admin, student, faculty } = useSelector((state) => {
    return state
  })
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          {student.login === true &&
            <Route path='/student/studentlogin' element={<Navigate to="/student/profile" />} />
          }
          {faculty.login === true &&
            <Route path='/faculty/facultylogin' element={<Navigate to="/faculty/profile" />} />
          }
